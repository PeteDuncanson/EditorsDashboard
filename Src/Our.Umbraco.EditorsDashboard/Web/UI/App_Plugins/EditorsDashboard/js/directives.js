angular.module('umbraco.directives').directive("umbNodePicker", [
    ...
    function (dialogService) {
        ...
        return {
            ...
            restrict: 'E',
            replace: true,
            template: '<ul class="unstyled list-icons">\
                <li ng-hide="model">\
                ...
                <li ng-show="model">\
                    <i class="icon icon-delete red" ng-click="clear()" style="cursor: pointer;"></i>\
                    <a href prevent-default ng-click="openPicker()" >{{model.name}}</a>\
                </li>\
            </ul>',
